...
if __name__ == '__main__':
    ...
    if sys.argv.__len__() > 1 and sys.argv[1] == 'create_kitti_infos':
        ...
        create_kitti_infos(
            ...
            class_names=['Down', 'Hover', 'Left', 'Right', 'Up', 'Front', 'Back'],
